...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 16 2021 г., 13:25
...
--
ALTER TABLE `advertisement`
  MODIFY `id_advertisement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT для таблицы `application`
--
ALTER TABLE `application`
  MODIFY `id_application` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT для таблицы `statistics`
--
ALTER TABLE `statistics`
  MODIFY `id_statistics` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
