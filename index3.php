...
if (!empty($_POST)) {
  ...
  $data = $dbh->prepare("SELECT heading, price, photo FROM advertisement INNER JOIN application on application.id_advertisement = advertisement.id_advertisement WHERE application.id_User = ?");
